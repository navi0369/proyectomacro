# src/proyectomacro/pages/cuentas_nacionales/balanza_de_pagos.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Balanza de pagos",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Balanza de pagos", "active": True},
        ],
