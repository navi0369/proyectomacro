# src/proyectomacro/pages/precios_y_producción/precio_oficial_minerales.py
import dash
...
TABLE_ID = "precio_oficial_minerales"
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Precios oficiales de minerales...", "active": True},
        ],
