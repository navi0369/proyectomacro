# src/proyectomacro/pages/precios_y_producción/inflacion_acumulada.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Inflación acumulada",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Inflación acumulada", "active": True},
        ],
