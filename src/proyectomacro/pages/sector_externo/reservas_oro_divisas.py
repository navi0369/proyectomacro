# src/proyectomacro/pages/sector_externo/reservas_oro_divisas.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Reservas internacionales de oro y divisas",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Reservas internacionales de or...", "active": True},
        ],
