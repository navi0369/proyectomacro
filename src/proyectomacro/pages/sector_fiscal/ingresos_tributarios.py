# src/proyectomacro/pages/sector_fiscal/ingresos_tributarios.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Ingresos Tributarios",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Ingresos Tributarios", "active": True},
        ],
