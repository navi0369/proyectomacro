# src/proyectomacro/pages/sector_fiscal/ingresos_corrientes.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Ingresos Corrientes",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Ingresos Corrientes", "active": True},
        ],
