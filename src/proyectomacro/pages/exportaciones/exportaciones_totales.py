# src/proyectomacro/pages/exportaciones/exportaciones_totales.py
import dash
...
if metadata is None:
    metadata = {
        "Nombre descriptivo": "Exportaciones Totales",
        "Período": "N/A",
        "Unidad": "N/A",
...
layout = dbc.Container([
    build_breadcrumb(
        crumbs=[
            ...
            {"label": "Exportaciones Totales", "active": True},
        ],
