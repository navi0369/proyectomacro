...
\texttt{petroleo}                & REAL    & Petróleo crudo y gas natural (\% PIB) \\
...
\texttt{transportes}             & REAL    & Transporte, almacenamiento y comunicaciones (\% PIB) \\
\texttt{comercio\_finanzas}      & REAL    & Comercio y servicios financieros/empresas (\% PIB) \\
\texttt{gobierno\_general}       & REAL    & Gobierno general (\% PIB) \\
\texttt{propiedad\_vivienda}     & REAL    & Propiedad de vivienda (\% PIB) \\
\texttt{servicios}               & REAL    & Servicios comunales, sociales, personales y hoteles (\% PIB) \\
\end{longtable}
...
total\_coparticipación\_tributaria     & REAL                & Copart. tributaria       \\
total\_idh                             & REAL                & IDH total                \\
total\_hipc\_ii                        & REAL                & HIPC II                  \\
total\_regalías\_departamentales       & REAL                & Regalías dept.           \\
...
ingresos\_tributarios\_total         & REAL                & Total de ingresos tributarios (Millones de BOB)                     \\
\end{longtable}
